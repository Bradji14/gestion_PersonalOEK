  ...
  // $_SESSION['error']="campos vacios";
    ...
    && !empty($numbers) && !empty($options))
    {
      ...
      if($numeroDeFilas<=0){
        ...
        header("Location: http://192.168.100.200:50/asistencias_empleado/vistas/movistar/permisosmov.php");
          ...
          $query->execute([$empleado,$arae,$jefe,$motivo,($numbers.' '.$options),$newDate,$compa,0,$fechaActual]);
            ...
            $_SESSION['listo']="Permiso agregado";
             header("Location: http://192.168.100.200:50/asistencias_empleados/vistas/movistar/permisosmov.php");
