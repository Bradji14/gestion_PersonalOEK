...
if (!empty($_POST['fecha_inicio']) && !empty($_POST['seleccion']) || empty($_POST['fecha_inicio']) && empty($_POST['seleccion']) ){
    ...
    $sql1 = "SELECT * FROM listacontrol WHERE fecha='$date' and company='Movistar'";
...
<nav class="navbar navbar-expand-lg mov">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="consultamov.php">Pase lista</a></li>
                        <!-- <li><a class="dropdown-item" href="consulta_rangomov.php">Asistencia de un rango de fechas</a>
                        </li> -->
                        <!-- <li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="permutasmov.php">Permutas<a></li>
                        <li><a class="dropdown-item" href="permisosmov.php">Permiso laboral</a></li>
                        <!-- <li>
                            <hr class="dropdown-divider">
                        </li>
                        <li><a class="dropdown-item" href="#">Something else here</a></li> -->
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="permutasregmov.php">Permutas registradas<a></li>
                        <li><a class="dropdown-item" href="permisosregmov.php">Permisos registrados</a></li>
                ...
                <!-- <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="permutasregAutoMov.php">Permutas <a></li>
                        <li><a class="dropdown-item" href="permisosregAutoMov.php">Permisos    </a></li>
                    </ul>
                </li> -->
                <div class="position-absolute top-0 end-0"> 
             
             <div class="text-end p-4">  
             <p class="nameNav"> <i class="fa fa-user m-3" style="font-size: 20px;"></i>EDGAR ZURITA LUNA</p>          
...
<h5 class="text-center text-light mt-4">Tabla de ASISTENCIAS</h5>
            
                <form action="asmov.php" method="post">
                <div class="container-fluid h-100"> 
                    <div class="row w-100 align-items-center">
                        <div class="col text-center">
                            <button class="btn btn-success mt-5 mb-2"> Confirmar pase de lista</button>
                            <a  href="consultamov.php" class="btn btn-warning mt-5 mb-2"> Regresar</a>
                        </div>	
                    </div>
                    ...
                    foreach ($query as $row):
                        ...
                        elseif(intval(str_replace (":", '',substr($row['fecha_hora'], -6))) <= intval(str_replace(":", '',$row['entrada']))+230):?>
                            ...
                            <td><input type="number" value="<?= $row['nomina']?>" name="id[]"></td>
                                   ...
                                   <td style='background-color: purple; color:white; font-weight: bold; font-size:14px'>ENTRADA DISTINTA</td>
