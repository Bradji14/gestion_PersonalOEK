        ...
        <div class="row">
            <div class="col-md-4 mx-auto">
                ...
                // session_unset();
                    ...
                    <form action="../consultas/permisobusqhsbc.php" method="POST" class="forName" autocomplete="off">

                        <div class="form-group">
                            <label for="empleado" class="form-label" id="nameEmpleado">Nomina empleado</label>
                            <input type="number" class="form-control" name="empleado"  id="nomi"
                                onblur="buscar_datos();" style="background:white;color:black;" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="formn-label">Área</label>
