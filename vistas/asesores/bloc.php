...
<body>
    ...
    <nav style="background:#002f4f">
        ...
        <div class="d-flex justify-content-around">
            ...
            <span style="--l: '¡H'"><?=$name?></span>
                <span style="--l: 'e';"><?=$ap?></span>
                <span style="--l: 'l';"><?=$am?></span>
    ...
    <div class="m-5">
        ...
        <div class="d-flex justify-content-around m-5">
            ...
            <div class="hrs mt-5" style="background:#002f4f;color:#c7dcea;padding:20px;box-shadow: rgb(38, 57, 77) 0px 20px 30px -10px;border-radius:5px"></div>
            ...
            <p>Cierra la pestaña del checador antes de irte</p>
                ...
                <div class="reloj m-2" style="">
                    <!-- <p class="fecha"></p>
                    <p class="tiempo"></p> -->
                    <img src="../../img/call.gif" alt="" style="width:500px" class="call">
                    <img src="../../img/gok.gif" alt="" style="width:500px; display:none" class="eat">
